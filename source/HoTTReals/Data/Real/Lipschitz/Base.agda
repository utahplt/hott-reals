module HoTTReals.Data.Real.Lipschitz.Base where
...
module LipschitzMapApproximation
  (f : ℝ → ℝ) (L : ℚ) (φ : 0 < L)
  (ψ : Lipschitzℝ f L φ)
  (x : (ε : ℚ) → 0 < ε → ℝ)
  (ω : CauchyApproximation x)
  ...
  lipschitzMapApproximation : (ε : ℚ) → 0 < ε → ℝ
  ...
  lipschitzMapApproximationCauchy ε δ χ π =
    ...
    ρ : Close
          ...
          (0<+' {x = ε / L [ φ' ]} {y = δ / L [ φ' ]}
            (0</' {x = ε} {y = L} χ φ)
            (0</' {x = δ} {y = L} π φ))
          (x (ε / L [ φ' ]) (0</' {x = ε} {y = L} χ φ))
          (x (δ / L [ φ' ]) (0</' {x = δ} {y = L} π φ))
    ρ = ω (ε / L [ φ' ]) (δ / L [ φ' ])
          (0</' {x = ε} {y = L} χ φ)
          (0</' {x = δ} {y = L} π φ)
    ...
    σ' : Σ (0 < ε + δ)
          (λ ξ → Close (ε + δ) ξ
                       (f (x (ε / L [ φ' ]) (0</' {x = ε} {y = L} χ φ)))
                       (f (x (δ / L [ φ' ]) (0</' {x = δ} {y = L} π φ))))
    σ' = subst (λ ?x → Σ (0 < ?x)
                (λ ξ → Close ?x ξ
                  (f (x (ε / L [ φ' ]) (0</' {x = ε} {y = L} χ φ)))
                  (f (x (δ / L [ φ' ]) (0</' {x = δ} {y = L} π φ)))))
    ...
    σ'' : Close (ε + δ) (0<+' {x = ε} {y = δ} χ π)
                (f (x (ε / L [ φ' ]) (0</' {x = ε} {y = L} χ φ)))
                (f (x (δ / L [ φ' ]) (0</' {x = δ} {y = L} π φ)))
    σ'' = subst (λ ?ξ → Close (ε + δ) ?ξ _ _)
                (isProp< 0 (ε + δ) (fst σ') (0<+' {x = ε} {y = δ} χ π))
                (snd σ')
  ...
  lipschitzMapApproximationLimit =
    ...
    χ ε π = υ'' -- υ''
      where
      π' : 0 < ε / 2 [ ℚ.2≠0 ]
      π' = 0</ {x = ε} {y = 2} π 0<2 ℚ.2≠0

      π'' : 0 < ε / 4 [ ℚ.4≠0 ]
      π'' = 0</ {x = ε} {y = 4} π 0<4 ℚ.4≠0

      μ : 0 < (ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹
      μ = 0<· {x = ε / 4 [ ℚ.4≠0 ]} {y = L [ φ' ]⁻¹} π'' (0<⁻¹ {x = L} φ φ')

      -- Naming these because Agda was getting stuck unifying them in the proof
      -- terms below
      y : ℝ
      y = limit lipschitzMapApproximation lipschitzMapApproximationCauchy

      z : ℝ
      z = (f (x ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) μ))

      ρ : Close (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ])
                (0<+' {x = ε / 4 [ ℚ.4≠0 ]} {y = ε / 4 [ ℚ.4≠0 ]} π'' π'')
                y
                z
      ρ = limitClose'' lipschitzMapApproximation
                       lipschitzMapApproximationCauchy
      ...
      τ : Close (L · (((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) +
                ...
                (f (x ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) μ))
                (f (limit x ω))
      τ = ψ (x ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) μ) (limit x ω)
            (((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) +
             ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹))
            (0<+' {x = (ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹}
                  {y = (ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹} μ μ) σ
      ...
      ν = L · (((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) +
               ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹))
            ≡⟨ cong (_·_ L) (sym $ ·DistR+
                 (ε / 4 [ ℚ.4≠0 ]) (ε / 4 [ ℚ.4≠0 ]) (L [ φ' ]⁻¹)) ⟩
          L · ((ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹)
            ≡⟨ cong (_·_ L) (·Comm
                 (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]) (L [ φ' ]⁻¹)) ⟩
          L · (L [ φ' ]⁻¹ · (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]))
            ≡⟨ ·Assoc L (L [ φ' ]⁻¹)
                 (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]) ⟩
          (L · L [ φ' ]⁻¹) · (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ])
            ≡⟨ cong (flip _·_ (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]))
                    (⁻¹-inverse L φ') ⟩
          1 · (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ])
            ≡⟨ ·IdL (ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]) ⟩
          ε / 4 [ ℚ.4≠0 ] + ε / 4 [ ℚ.4≠0 ]
            ≡⟨ self/4≡self/2 ε ℚ.4≠0 ℚ.2≠0 ⟩
          ε / 2 [ ℚ.2≠0 ] ∎
      ...
      τ' = subst (λ ?x →
                   Σ (0 < ?x)
                   (λ ξ → Close ?x ξ (f (x ((ε / 4 [ ℚ.4≠0 ]) · L [ φ' ]⁻¹) μ))
                                     (f (limit x ω))))
                 ν
                 (_ , τ)

      υ : Close (ε / 2 [ ℚ.2≠0 ] + ε / 2 [ ℚ.2≠0 ])
                (0<+' {x = ε / 2 [ ℚ.2≠0 ]} {y = ε / 2 [ ℚ.2≠0 ]}
                      (fst ρ') (fst τ'))
                (limit lipschitzMapApproximation
                       lipschitzMapApproximationCauchy)
                (f (limit x ω))
